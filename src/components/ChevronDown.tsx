...
const ChevronDown = (props: IconProps) => {
    ...
    try {
      ...
      return (
        <Svg
          ...
          {...props}
        >
          <Path d="M3.5 5.25L7 8.75L10.5 5.25"    stroke={props.stroke || props.color || "#ACB4BD"} strokeWidth={props.strokeWidth || 1.16667} strokeLinecap="round" strokeLinejoin="round"/>
        </Svg>
      );
    } catch (error) {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M3.5 5.25L7 8.75L10.5 5.25" stroke="#ACB4BD" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  );
};
