...
const ChevronRight = (props: IconProps) => {
    ...
    try {
      ...
      return (
        <Svg
          ...
          {...props}
        >
          <Path d="M5.25 10.5L8.75 7L5.25 3.5"    stroke={props.stroke || props.color || "#ACB4BD"} strokeWidth={props.strokeWidth || 1.16667} strokeLinecap="round" strokeLinejoin="round"/>
        </Svg>
      );
    } catch (error) {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M5.25 10.5L8.75 7L5.25 3.5" stroke="#ACB4BD" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  );
};
