...
const Plus = (props: IconProps) => {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M2.91669 7H11.0834" stroke="#ACB4BD" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M7 2.91675V11.0834" stroke="#ACB4BD" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
};
