...
const Trash = (props: IconProps) => {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M1.75 3.5H12.25" stroke="#ACB4BD" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M11.0834 3.5V11.6667C11.0834 12.25 10.5 12.8333 9.91669 12.8333H4.08335C3.50002 12.8333 2.91669 12.25 2.91669 11.6667V3.5" stroke="#ACB4BD" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M4.66669 3.50008V2.33341C4.66669 1.75008 5.25002 1.16675 5.83335 1.16675H8.16669C8.75002 1.16675 9.33335 1.75008 9.33335 2.33341V3.50008" stroke="#ACB4BD" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M5.83331 6.41675V9.91675" stroke="#ACB4BD" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M8.16668 6.41675V9.91675" stroke="#ACB4BD" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
};
