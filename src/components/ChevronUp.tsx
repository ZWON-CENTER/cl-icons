...
const ChevronUp = (props: IconProps) => {
    ...
    try {
      ...
      return (
        <Svg
          ...
          {...props}
        >
          <Path d="M10.5 8.75L7 5.25L3.5 8.75"    stroke={props.stroke || props.color || "#ACB4BD"} strokeWidth={props.strokeWidth || 1.16667} strokeLinecap="round" strokeLinejoin="round"/>
        </Svg>
      );
    } catch (error) {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M10.5 8.75L7 5.25L3.5 8.75" stroke="#ACB4BD" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  );
};
